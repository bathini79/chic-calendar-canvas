...
export default function AdminDashboard() {
  ...
  const todayStats = {
    total: todayAppointmentsData.length,
    confirmed: todayAppointmentsData.filter(app => app.status === 'confirmed').length,
    booked: todayAppointmentsData.filter(app => app.status === 'booked').length,
    cancelled: todayAppointmentsData.filter(app => app.status === 'canceled').length,
  };
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      {/* First row: Recent sales and Today's appointments */}
