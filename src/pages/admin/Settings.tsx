    ...
    <div className="container py-4 md:py-6 px-4 max-w-6xl">
      <div className="mb-4 md:mb-6">
        ...
        <p className="text-sm md:text-base text-muted-foreground">
          Manage settings for your business.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 mb-6 md:mb-8">
            ...
            <CardContent className="pt-4 md:pt-6">
              <div className="flex flex-col h-full">
                ...
                <p className="text-xs md:text-sm text-muted-foreground">
                  Customize business details, manage locations, and client
                  referral sources.
                </p>
              </div>
            </CardContent>
        ...
        <Link to="/admin/settings/scheduling">
          <Card className="h-full hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="pt-4 md:pt-6">
              <div className="flex flex-col h-full">
                <div className="mb-3 md:mb-4">
                ...
                <p className="text-xs md:text-sm text-muted-foreground">
                  Set your availability, manage bookable resources and online
                  booking preferences.
                </p>
              </div>
            </CardContent>
          ...
          <Card className="h-full hover:shadow-md transition-shadow cursor-pointer">
            <CardContent className="pt-4 md:pt-6">
              <div className="flex flex-col h-full">
                ...
                <p className="text-xs md:text-sm text-muted-foreground">
                  Configure payment methods, taxes, coupons, loyalty program and
                  memberships.
                </p>
              </div>
            </CardContent>
