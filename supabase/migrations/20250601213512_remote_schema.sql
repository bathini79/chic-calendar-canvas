...
BEGIN
    ...
    -- Step 2: Insert or update pay_run_items
    INSERT INTO pay_run_items (
        pay_run_id,
        employee_id,
        compensation_type,
...
CREATE TABLE IF NOT EXISTS "public"."commission_templates" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "commission_templates_type_check" CHECK ((("type")::"text" = ANY ((ARRAY['flat'::character varying, 'tiered'::character varying])::"text"[])))
);
...
CREATE TABLE IF NOT EXISTS "public"."employees" (
    ...
    CONSTRAINT "employees_commission_type_check" CHECK ((("commission_type")::"text" = ANY ((ARRAY['flat'::character varying, 'tiered'::character varying, 'none'::character varying])::"text"[]))),
