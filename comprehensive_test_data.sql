...
('e3a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b503', 'e253f6af-94a0-44aa-b635-79fd21b3aec0', 'intermediate', NOW(), NOW()), -- Blow Dry Short

-- David (Assistant) - Basic services
('e5a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b505', 'df7da949-5425-4093-b205-2a5d2ef2a439', 'intermediate', NOW(), NOW()), -- Moisturizing Hair Spa Short
('e5a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b505', 'e253f6af-94a0-44aa-b635-79fd21b3aec0', 'beginner', NOW(), NOW()), -- Blow Dry Short

-- Alex (Downtown Stylist) - All around skills
('e6a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b506', '86032c4c-c186-441d-a6eb-25187b926ff8', 'intermediate', NOW(), NOW()), -- Advance Hair Cut Short
('e6a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b506', 'e253f6af-94a0-44aa-b635-79fd21b3aec0', 'intermediate', NOW(), NOW()), -- Blow Dry Short
('e6a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b506', '40cde9f0-6d58-409a-920b-2b40dded15ce', 'intermediate', NOW(), NOW()), -- Root Touch Up Regular

-- Maria (Downtown Colorist) - Color specialist
('e7a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b507', '40cde9f0-6d58-409a-920b-2b40dded15ce', 'expert', NOW(), NOW()), -- Root Touch Up Regular
('e7a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b507', '53c57f10-6857-4e2e-8e29-f0ffd8ca35d3', 'expert', NOW(), NOW()), -- Fruit Facial
('e7a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b507', '86032c4c-c186-441d-a6eb-25187b926ff8', 'intermediate', NOW(), NOW()), -- Advance Hair Cut Short
('e7a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b507', 'e253f6af-94a0-44aa-b635-79fd21b3aec0', 'intermediate', NOW(), NOW()); -- Blow Dry Short
...
-- =====================================================================
-- 5. CUSTOMER PROFILES - Expanded for reporting
-- =====================================================================
...
('c1a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5c6', 'c1a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5c6', '+1555111001', true, 'Olivia Williams', 'referral', 'customer', 25.50, true, 'email', 8),

-- Loyalty Member
('c2a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5c7', 'c2a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5c7', '+1555111002', true, 'James Davis', 'google', 'customer', 75.00, true, 'whatsapp', 15),

-- New Customer
('c3a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5c8', 'c3a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5c8', '+1555111003', true, 'Sophia Anderson', 'facebook', 'customer', 0.00, true, 'email', 1),

-- Loyal Long-term Customer
('c4a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5c9', 'c4a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5c9', '+1555111004', true, 'William Brown', 'referral', 'customer', 45.00, true, 'whatsapp', 22),

-- Premium Service Customer
('c5a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5d0', 'c5a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5d0', '+1555111005', true, 'Ava Taylor', 'instagram', 'customer', 120.00, true, 'email', 6),

-- Additional customers for reporting
('c6a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5d1', 'c6a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5d1', '+1555111006', true, 'Robert Johnson', 'google', 'customer', 15.25, true, 'whatsapp', 12),

('c7a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5d2', 'c7a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5d2', '+1555111007', true, 'Jennifer Miller', 'referral', 'customer', 85.75, true, 'email', 9),

('c8a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5d3', 'c8a2b3c4-d5e6-f7a8-b9c0-d1e2f3a4b5d3', '+1555111008', true, 'Michael Wilson', 'referral', 'customer', 35.00, true, 'whatsapp', 4),
...
-- =====================================================================
-- 5. EMPLOYEE PROFILES - Matching auth_id from employees table
-- =====================================================================
...
-- Employee Profiles to match auth_id from employees table
